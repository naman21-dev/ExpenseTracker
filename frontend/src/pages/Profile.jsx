...
import { Eye, EyeOff, Lock, User, Mail, Calendar, X } from 'lucide-react';
                        ...
                        <div className={profileStyles.card}>
                            ...
                            <div className="mt-6">
                                <button
                                    ...
                                    className="w-full py-2.5 border border-red-200 text-red-500 rounded-xl font-medium hover:bg-red-50 transition-colors text-sm"
                                    disabled={loading}
                                >
                                    Log Out
                                </button>
